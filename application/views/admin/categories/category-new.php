...
<div id="breadcrumb">
    ...
    <a href="/admin/categories/category-new" class="current">Agregar nueva categoría</a>
</div>
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <?php echo form_open( '/admin/categories/category-new', array( 'class' => 'form-horizontal' ) ) . "\n"; ?>
