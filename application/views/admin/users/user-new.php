...
<div id="breadcrumb">
    ...
    <a href="/admin/users/user-new" class="current">Agregar nuevo usuario</a>
</div>
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <?php echo form_open( '/admin/users/user-new', array( 'class' => 'form-horizontal' ) ) . "\n"; ?>
                        <div class="control-group<?php if( form_error( 'username' ) ):?> error<?php endif; ?>">
                            ...
                            <div class="controls">
                                <?php echo form_input( array( 'name' => 'username', 'maxlength' => 100, 'value' => $arUser['username'], 'id' => 'username' ) ) . "\n"; ?>
