...
<div id="breadcrumb">
    ...
    <a href="/admin/purchases/purchase-new<?php if( $iCustomerId ): ?>?customer_id=<?php echo $iCustomerId; ?><?php endif; ?>" class="current">Agregar nueva compra</a>
</div>
        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Agregar nueva compra</h5>
                </div>
                <div class="widget-content nopadding">                    
                    <?php echo form_open( $iCustomerId ? '/admin/purchases/purchase-new?customer_id=' . $iCustomerId : '/admin/purchases/purchase-new', array( 'class' => 'form-horizontal' ) ) . "\n"; ?>
