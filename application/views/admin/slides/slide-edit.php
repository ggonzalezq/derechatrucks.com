...
<div id="breadcrumb">
    ...
    <a href="/admin/slides/slide-edit/<?php echo $iSlideId; ?>" class="current">Editar diapositiva</a>
</div>
        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Editar diapositiva</h5>
                </div>
                <div class="widget-content nopadding">
                    <?php echo form_open_multipart( '/admin/slides/slide-edit/' . $iSlideId, array( 'class' => 'form-horizontal' ) ) . "\n"; ?>
                        <div class="control-group<?php if( $sUploadError ): ?> error<?php endif; ?>">
                            ...
                            <div class="controls">
                                <img src="/uploads/slides/<?php echo $arSlide['slide_name']; ?>" alt="<?php echo $arSlide['slide_title']; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo form_label( 'Título', 'slide_title', array( 'class' => 'control-label' ) ) . "\n"; ?>
                            <div class="controls">
                                <?php echo form_input( array( 'name' => 'slide_title', 'maxlength' => 255, 'value' => set_value( 'slide_title', $arSlide['slide_title'] ), 'id' => 'slide_title' ) ) . "\n"; ?>
                            </div>
                        </div>
                        <div class="control-group<?php if( form_error( 'slide_anchor' ) ):?> error<?php endif; ?>">
                            ...
                            <div class="controls">
                                <?php echo form_input( array( 'name' => 'slide_anchor', 'value' => set_value( 'slide_anchor', $arSlide['slide_anchor'] ), 'id' => 'slide_anchor' ) ) . "\n"; ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo form_checkbox( array( 'name' => 'slide_badge', 'value' => '1', 'checked' => $bBadge, 'id' => 'slide_badge' ) ) . "\n"; ?>
                            </div>
                        </div>
